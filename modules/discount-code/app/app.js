...
module.exports = function discountCodeExample(app, options) {
  ...
  app.get('/modules/discount-code/', function (req, res) {
    //console.log('Setup the index redirect, response', res)
  ...
  app.post('/modules/discount-code/validate', function (req, res) {
    console.log(
      'debug: /modules/discount-code/validate',
  ...
  app.post('/modules/discount-code/execute', function (req, res) {
    ...
    function getInArgument(k) {
      ...
      console.log('request.inarguments', request.inArguments)
    ...
    const responseObject = {
      name: getInArgument('FirstName') || 'Nohing',
      discount: getInArgument('discount') || 'nothing',
      anotherDiscount: getInArgument('anotherDiscount') || 'nothing',
      key: getInArgument('key') || 'nothing',
      FirstName1: getInArgument('FirstName1') || 'nothing',
      FirstName2: getInArgument('FirstName2') || 'nothing',
      FirstName3: getInArgument('FirstName3') || 'nothing',
      FirstName4: getInArgument('FirstName4') || 'nothing',
      discountCode: generateRandomCode() + `-${getInArgument('discount')}%`,
      fullObject: request.inArguments,
    }
